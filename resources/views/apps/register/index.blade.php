                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <a class="text-center" href="{{ route('app.register.index') }}"> <h4>Register</h4></a>

                                <form method="POST" action="{{ route('app.register.post') }}" class="mt-5 mb-5 login-input">
                                    @csrf
                                ...
                                <p class="mt-5 login-form__footer">Dont have account? <a href="{{ route('app.login.index') }}" class="text-primary">Sign In</a> now</p>
                            </div>
                        </div>
                    </div>
                </div>
